...
`
  ...
  },
  {
    ...
    text: `rettskrivingsreform – riksmål (bløte konsonanter fjernes) <br>` +
        ...
        <li>Norsk Riksmålsforbund stiftes – kamporganisasjon. </li></ul> <p><br>Første rettskrivningsreform, dansk-norsken får navnet "riksmål"<br><br>
        Fra 1900-tallet har utviklingen vært preget av de store rettskrivningsreformene: 1901 for landsmålet, 1907 for riksmålet, en mindre i 1910 for landsmål, og så for begge mål i 1917 og 1938, den siste med revisjon i 1959 og for bokmål i 1981 og 2005, foruten en del detaljrevisjoner etter forslag fra Norsk språkråd. For riksmål/bokmål har virkningen vært at det fra 1907 helt klart er et norsk skriftspråk og ikke et dansk. Der det er avvik mellom historisk skrivemåte og vanlig uttale, har begge mål nærmet seg uttalegjengivelse, og landsmål/nynorsk har gradvis tatt mer hensyn til østnorsk talemål og bydialektene.</p>`
  },
  {
    year: 1917,
...
<br>Helt fra begynnelsen av 1900-tallet har det vært arbeidet på å fjerne unødige forskjeller mellom de to mål. Norsk språknemnd (1952–1972) skulle fremme tilnærming mellom de to skriftmål «på norsk folkemåls grunn»; Norsk språkråd (1972–2004) skulle «støtte opp om utviklingstendenser som på lengre sikt fører målformene nærmere sammen». Om målet skulle være ett «samnorsk» skriftspråk eller ikke, og hvor snarlig det eventuelt skulle gjennomføres, har vært det store språkstridsemne i mellom- og etterkrigstiden. Reformen i bokmålet i 1981 åpnet for en rekke tradisjonelle former som var blitt stengt ute tidligere, særlig i 1938, og etter det har hovedtendensen vært konsolidering. I 2002 ble Norsk språkråds tilnærmingsparagraf opphevet av Stortinget, og i 2005 ble en del lite brukte former, særlig tilnærmingsformer, tatt ut av normalen.<br><br>
</p>
`
  },
  {
    year: 1929,
    text: "Stortinget endrer \"landsmål og riksmål\" til \"nynorsk og bokmål\"."
  },
  {
    year: 1938,
...
`
  ...
  {
    year: "Nå",
    text: "Språkutviklingen i vår tid preges sterkt av tilstrømningen av lånord, særlig fra engelsk (anglisismer) og svensk (svesismer). Flytting, pendling, massemedia og andre sider ved samfunnsutviklingen bidrar til å jevne ut ulikheter i talemålet. Men store og rasktvirkende endringer i skole, arbeidsliv og så videre har skapt større språklig ulikhet mellom eldre og yngre, yrkesaktive og ikke-yrkesaktive. Språket i massemedia og administrasjon øver sterkere innflytelse på språksamfunnet som helhet i vår tid enn frem til om lag 1900. Tendensen til at komplisert fagspråk «invaderer» allmennspråket, særlig i trykte, eterbaserte og digitale media, blir balansert av enklere strukturer, for eksempel i form av kortere setninger og en mindre komplisert setningsbygning"
  }
];
...
function mainTop() {
  // adjust margin top
  main.style.setProperty('--mainTop', `-${24*navHeight}px`);
}
